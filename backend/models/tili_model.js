...
const Tili = {
  ...
  getById: function(id, callback) {
    return db.query('SELECT SaldoDebit, SaldoCredit, pvm AS DATE, TapahtumaNimi, SummaDebit, SummaCredit FROM tilitapahtumat JOIN Tili ON tilitapahtumat.idTili=Tili.idTili JOIN Kortti ON Tili.idTili=Kortti.idTili WHERE Kortti.idKortti=? ORDER BY pvm DESC;', [id], callback);
  },
